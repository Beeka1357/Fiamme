...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" method="post" action="{{ route('update.product', ['id' => $products->id]) }}">
                @csrf
						 ...
						 @endforeach
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="subcategory_id" class="form-select" id="inputCollection">
                                            ...
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $products->subcategory_id ? 'selected' : '' }}>{{ $subcat->subcategory_name }}
                                                @endforeach
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                   <input class="form-check-input" name="offer[]" type="checkbox" value="1" id="flexCheckDefault" {{ in_array($offer->slug, explode('-', $products->offer)) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group col-md-6">
												<div class="form-check">
													<input class="form-check-input" name="offer[]" type="checkbox" value="{{$offer->offers_slug}}" id="flexCheckDefault" {{ $products->offer == 1 }}>
													<label class="form-check-label" for="flexCheckDefault"> {{ucwords($offer->offers_name)}}</label>
												</div>
											</div>
                                            @endforeach
            ...
            <table class="table mb-0 table-striped">
                ...
                <tbody>
                    ...
                    <form method="post" action="{{ route('update.product.multiimage') }}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="multi_img_id" value="{{ $img->id }}">
                        <tr>
