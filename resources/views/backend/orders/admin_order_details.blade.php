                    ...
                    <table class="table" style="background:#F4F6FA;font-weight: 600;">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="{{ route('pending-confirm',$order->id) }}" class="btn btn-block btn-primary" id="confirm">Confirm Order</a>
                                @elseif($order->status == 'confirm')
                                <a href="{{ route('confirm-processing',$order->id) }}" class="btn btn-block btn-primary" id="processing" >Processing Order</a>
                                @elseif($order->status == 'processing')
                                <a href="{{ route('processing-delivered',$order->id) }}" class="btn btn-block btn-primary" id="delivered" >Delivered Order</a>
                                @endif
