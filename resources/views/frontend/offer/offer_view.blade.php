...
@section('title')
   {{ $breadsuboffer->offers_name }} Offer
@endsection
    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-3">
                    <h5 class="mb-15">{{ $breadsuboffer->offers_name }}</h5>
                    <div class="breadcrumb">
                        <a href="{{ url('/') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                        <span></span> {{ $breadsuboffer->offers_name }}
                    </div>
                </div>
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    ...
                    <li>
                        <a href="shop-grid-right.html"> <img src=" {{ asset($category->category_image) }} " alt="" />{{ $category->category_name }}</a><span class="count-custom">{{ $category->prod_count }}</span>
                    </li>
                    @endforeach
                </ul>
            </div>
